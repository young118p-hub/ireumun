...
class SajuConstants {
  ...
  // 양(+): 갑, 병, 무, 경, 임 (짝수 인덱스)
  // 음(-): 을, 정, 기, 신, 계 (홀수 인덱스)
  static bool isYangStem(int stemIndex) => stemIndex % 2 == 0;

  // ============================================================
  // 오행 상생 관계 (五行相生)
  // 나(key)가 생하는 오행 → value (식상/아생)
  // ============================================================
  static const Map<String, String> ohengIGenerate = {
    '목': '화', // 木生火
    '화': '토', // 火生土
    '토': '금', // 土生金
    '금': '수', // 金生水
  ...
  // 나(key)를 생해주는 오행 → value (인성/생아)
  static const Map<String, String> ohengGeneratesMe = {
    '목': '수', // 水生木
    '화': '목', // 木生火
    '토': '화', // 火生土
    '금': '토', // 土生金
  ...
  // ============================================================
  // 오행 상극 관계 (五行相剋)
  // 나(key)가 극하는 오행 → value (재성/아극)
  // ============================================================
  static const Map<String, String> ohengIControl = {
    '목': '토', // 木克土
    '화': '금', // 火克金
    '토': '수', // 土克水
    '금': '목', // 金克木
  ...
  // 나(key)를 극하는 오행 → value (관성/극아)
  static const Map<String, String> ohengControlsMe = {
    '목': '금', // 金克木
    '화': '수', // 水克火
    '토': '목', // 木克土
    '금': '화', // 火克金
